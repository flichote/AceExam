...
| 任务 | 卡片 ID | 备注 |
|---|---|---|
| T28 | t_37b117e3 | 本任务（架构增量 + API 契约 + 任务图），done ✅ |
| T29 | t_6ea92fe6 | 待 T28 done 自动解锁 |
| T30 | t_19f4f89c | 待 T28 done 自动解锁 |
| T31 | t_5f5ba3dd | parent=T30（接口先行，与 T30 并行） |
| T32 | t_82779a7b | 待 T28 done 自动解锁 |
| T33 | t_f8cb7781 | parents=T30+T31+T32 |
